 ...
 * be performed
 */
template<class SQL_TYPE, class ODBC_TYPE = void, class DAP_TYPE = libdap::BaseType, // inherit from
 ...
 */
template<class SQL_TYPE, class ODBC_TYPE, class DAP_TYPE> // inherit from
//	void> // FORCED the cast output type
// actually it is 'void' to use buf2val
// change this if you want to use set_val
class SQLSimpleType<SQL_TYPE, ODBC_TYPE, DAP_TYPE> : public SQLBaseType<SQL_TYPE, ODBC_TYPE, DAP_TYPE, void> {
private:
    bool _reuse;
public:
    /**
