...
TESTDEBUG(SQL_NAME_TEST,"ObjectActionList: doNext: "<<_iterator<<std::endl);
...
TESTDEBUG(SQL_NAME_TEST,"CREATED: OBJECT ACTION LIST"<<std::endl);
	};
...
TESTDEBUG(SQL_NAME_TEST,"DELETED: OBJECT ACTION LIST"<<std::endl);
	};
};
